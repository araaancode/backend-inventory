...
const orderSchema = new mongoose.Schema(
  {
    title: {
      ...
      validate: {
        ...
        message: "Order title can only contain letters, numbers, and Persian characters"
      }
    },
    orderOwner: {
    ...
    status: {
      ...
      enum: {
        ...
        message: 'Status must be either pending, processing, completed, or cancelled'
      },
      default: 'pending'
    }
  },
...
orderSchema.index({ orderOwner: 1 });
